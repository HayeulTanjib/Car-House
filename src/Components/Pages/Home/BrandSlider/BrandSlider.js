    ...
    <div className='mb-5'>
      ...
      <div>
        <div>
          <Slider {...settings}>
            <div className=''>
              <img src="https://i.ibb.co/1XppmGG/toyota-logo-removebg-preview.png" className='img-fluid' alt="" />
            </div>
            <div>
              <img src="https://i.ibb.co/jWMCt8P/Nissan-Logo-2-removebg-preview.png" className='img-fluid w-50' alt="" />
            </div>
            <div>
